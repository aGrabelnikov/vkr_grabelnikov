...
import com.example.newanimals.fragment.work.head.WorkHeadFragment2;
import com.example.newanimals.fragment.work.worker.WorkWorkerFragment2;
import com.example.newanimals.utils.SPHelper;

import butterknife.BindView;

public class ChooseSferaZanitostiFragment extends BaseFragment {
    @BindView(R.id.it)
    LinearLayout it;
    @BindView(R.id.auto)
    LinearLayout auto;
    ...
    public static ChooseSferaZanitostiFragment newInstance() {
        return new ChooseSferaZanitostiFragment();
    }
    ...
    protected void initViews() {
        ...
        it.setOnClickListener(v->{
            ...
            ((CreateAdsActivity)getActivity()).replaceFragment(WorkWorkerFragment2.newInstance(), true);
        });
