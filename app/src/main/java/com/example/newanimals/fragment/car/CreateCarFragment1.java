...
import com.example.newanimals.fragment.biznes.CreateBiznesAddNameFragment;
...
public class CreateCarFragment1 extends BaseFragment implements LoadPhotoView {
    ...
    @BindView(R.id.image)
    ImageView image;
    public static CreateCarFragment1 newInstance() {
        return new CreateCarFragment1();
    }
    ...
    protected void initViews() {
        ...
        nexBtn.setOnClickListener(v->{
            ((CreateAdsActivity)getActivity()).replaceFragment(CreateCarFragment2.newInstance(), true);
        });
    }
    ...
    protected int layoutId() {
        return R.layout.create_ads_for_cars_fragment_1;
    }
